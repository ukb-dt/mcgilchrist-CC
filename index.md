...
$\overline{y'_x}$: averaged local sensitivity.
...
• $\overline{y'_x} \pm z\sqrt{y''_x}$: Agency — curvature coupling
...
• **Agency / $\overline{y'_x} \pm z\sqrt{y''_x}$**
This is the fork.
...
$$ \overline{y'_x} \pm z\sqrt{y''_x} \quad \text{(agency)} \rightarrow \text{phenotypic plasticity, niche construction, evolvability} $$
...
4.  $\overline{y'_x} \pm z\sqrt{y''_x}$ (Agency) $\rightarrow$ **Phenotypic Plasticity / Evolvability**.
